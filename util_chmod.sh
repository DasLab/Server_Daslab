...
sudo chmod 640 media/css/* media/fonts/* media/html/* media/fonts/GillSans/* media/fonts/Helvetica/* media/js/* media/js/admin/* media/js/suit/* media/_old/* media/swf/*
sudo chmod 750 media/css media/fonts media/fonts/GillSans media/fonts/Helvetica media/html media/js media/js/admin media/js/suit media/_old media/swf media
