        ...
        success: function (data) {
            ...
            setTimeout(function() {
                ...
                for (var i = 0; i < data.ec2.length; i++) {
                    ...
                    html += '<div class="row" id="ec2-' + data.ec2[i].name + '"><div class="col-lg-9 col-md-9 col-sm-9 col-xs-9"><p><span class="lead">' + ec2 + '&nbsp;&nbsp;<b><u>' + data.ec2[i].name + '</u></b></span>&nbsp;&nbsp;<span class="label label-orange">' + data.ec2[i].id + '</span>&nbsp;<span class="label label-primary">' + data.ec2[i].type + '</span>&nbsp;<span class="label label-info">' + data.ec2[i].arch + '</span>&nbsp;<span class="label label-violet">' + data.ec2[i].region + '</span></p><p><a href="http://' + data.ec2[i].dns + '" target="_blank"><code>' + data.ec2[i].dns + '</code></a></p></div><div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"><p class="text-right"><span class="label label-inverse">Credits Balance</span></p><p class="text-right"><i><mark>' + data.ec2[i].credit + '</mark></i></p></div></div><div class="row"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><div id="plot_cpu_' + data.ec2[i].id + '" class="thumbnail place_holder" style="padding:0px 20px; height: 150px;"></div></div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><div id="plot_net_' + data.ec2[i].id + '" class="thumbnail place_holder" style="padding:0px 20px; height: 150px;"></div></div></div>';
            ...
            setTimeout(function() {
                ...
                for (var i = 0; i < data.elb.length; i++) {
                    ...
                    html += '<div class="row" id="elb-' + data.elb[i].name + '"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><p><span class="lead">' + elb + '&nbsp;&nbsp;<b><u>' + data.elb[i].name + '</u></b></span>&nbsp;&nbsp;<span class="label label-orange">' + data.ec2[i].id + '</span>&nbsp;<span class="label label-primary">' + data.ec2[i].type + '</span>&nbsp;<span class="label label-info">' + data.ec2[i].arch + '</span>&nbsp;<span class="label label-violet">' + data.elb[i].region + '</span></p><p><a href="http://' + data.elb[i].dns + '" target="_blank"><code>' + data.elb[i].dns + '</code></a></p></div></div><div class="row"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><div id="plot_lat_' + data.elb[i].name + '" class="thumbnail place_holder" style="padding:0px 20px; height: 150px;"></div></div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><div id="plot_req_' + data.elb[i].name + '" class="thumbnail place_holder" style="padding:0px 20px; height: 150px;"></div></div></div>';
            ...
            setTimeout(function() {
                ...
                for (var i = 0; i < data.ebs.length; i++) {
                    ...
                    html += '<div class="row" id="ebs-' + data.ebs[i].name + '"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><p><span class="lead">' + ebs + '&nbsp;&nbsp;<b><u>' + data.ebs[i].name + '</u></b></span>&nbsp;&nbsp;</p><p><span class="label label-orange">' + data.ebs[i].id + '</span>&nbsp;<span class="label label-primary">' + data.ebs[i].type + '</span>&nbsp;<span class="label label-info">' + data.ebs[i].size + ' GB</span>&nbsp;<span class="label label-violet">' + data.ebs[i].region + '</span>' + encrpyed + '</p></div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><div id="plot_disk_' + data.ebs[i].id + '" class="thumbnail place_holder" style="padding:0px 20px; height: 150px;"></div></div></div>'
