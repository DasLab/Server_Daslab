...
$.ajax({
    ...
    success: function (data) {
        ...
        for (var i = 0; i < data.git.length; i++) {
            ...
            html += '<div class="row"><div class="col-md-6"><p><span class="lead"><mark><b><u>' + data.git[i].id + '</u></b></mark></span>&nbsp;&nbsp;' + lb_private + '</p><p><a href="http://' + data.git[i].url + '" target="_blank"><code>' + data.git[i].url + '</code></a></p><p id="git-label-' + data.git[i].name + '"></p><table class="table"><thead><tr class="active"><th class="col-md-3"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;Account</th><th class="col-md-3"><span class="glyphicon glyphicon-circle-arrow-up"></span>&nbsp;&nbsp;Commits</th><th class="col-md-3"><span class="glyphicon glyphicon-plus-sign"></span>&nbsp;&nbsp;Additions</th><th class="col-md-3"><span class="glyphicon glyphicon-minus-sign"></span>&nbsp;&nbsp;Deletions</th></tr></thead><tbody>';
            ...
            html += '<tr><td colspan="4" style="padding: 0px;"></td></tr></tbody></table></div><div class="col-md-6"><div id="plot_c_' + data.git[i].name + '" class="thumbnail git place_holder" style="padding:0px 20px; height: 150px;"></div><div id="plot_ad_' + data.git[i].name + '" class="thumbnail git place_holder" style="padding:0px 20px; height: 150px;"></div></div></div>';
