...
$(document).ready(function () {
    ...
    if ($(location).attr("href").indexOf("admin/src/news") != -1) {
        ...
        $("div.col-md-6 > h2.legend").html('<div class="i_slack_14"></div>&nbsp;' + $("div.col-md-6 > h2.legend").html() + '<span class="pull-right" style="font-weight:normal; font-size: 12px;">(Click values in first column to edit)</span>');
        $("ul.breadcrumb > li:first").next().remove();
        $("ul.breadcrumb > li:first").next().prepend('<div class="i_slack_21"></div>&nbsp;&nbsp;');
