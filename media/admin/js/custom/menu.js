...
$(document).ready(function () {
	...
	$('.left-nav>ul>li>ul>li>a[href="/admin/ga/"]').attr("disabled", "disabled").css("text-decoration", "line-through").attr("href", "");
	$('.left-nav>ul>li>ul>li>a[href="/admin/backup/"]').attr("disabled", "disabled").css("text-decoration", "line-through").attr("href", "");
