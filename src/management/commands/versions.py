...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--force', action='store_true', help='Flag to override SLACK BOT settings.')

    def handle(self, *args, **options):
        flag = (options['force'] == 1) if options['force'] else False
        if not (BOT['SLACK']['IS_VERSION'] or flag):
            return
        t0 = time.time()
        ...
        try:
            cpu = subprocess.Popen(
                'uptime | sed \'s/.*: //g\' | sed \'s/,/ \//g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()

            ver['linux'] = subprocess.Popen(
                'uname -r | sed \'s/[a-z\-]//g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['python'] = '%s.%s.%s' % (sys.version_info.major, sys.version_info.minor, sys.version_info.micro)
            ver['django'] = subprocess.Popen(
                'python -c \'import django; print django.__version__\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()

            open(os.path.join(MEDIA_ROOT, 'data/temp.txt'), 'w').write(
                subprocess.Popen(
                    'pip show django-crontab',
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()
            )
            ver['django_crontab'] = subprocess.Popen(
                'head -2 %s | tail -1 | sed \'s/.*: //g\'' % os.path.join(MEDIA_ROOT, 'data/temp.txt'),
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            open(os.path.join(MEDIA_ROOT, 'data/temp.txt'), 'w').write(
                subprocess.Popen(
            ...
            ver['django_environ'] = subprocess.Popen(
                'head -2 %s | tail -1 | sed \'s/.*: //g\'' % os.path.join(MEDIA_ROOT, 'data/temp.txt'),
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()

            ver['mysql'] = subprocess.Popen(
                'mysql --version | sed \'s/,.*//g\' | sed \'s/.*Distrib //g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['apache'] = subprocess.Popen(
                'apachectl -v | head -1 | sed \'s/.*\///g\' | sed \'s/[a-zA-Z \(\)]//g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            if DEBUG:
                ver['mod_wsgi'] = 'N/A'
            else:
                ver['mod_wsgi'] = subprocess.Popen(
                    'apt-cache show libapache2-mod-wsgi | grep Version | head -1 | sed \'s/.*: //g\' | sed \'s/-.*//g\'',
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()
            if DEBUG:
                ver['mod_webauth'] = 'N/A'
            else:
                ver['mod_webauth'] = subprocess.Popen(
                    'apt-cache show libapache2-webauth | grep Version | head -1 | sed \'s/.*: //g\' | sed \'s/-.*//g\'',
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()
            ver['openssl'] = subprocess.Popen(
                'openssl version | sed \'s/.*OpenSSL //g\' | sed \'s/[a-z].*//g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            if DEBUG:
                ver['wallet'] = 'N/A'
            else:
                ver['wallet'] = subprocess.Popen(
                    'wallet -v | sed \'s/.*wallet //g\'',
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()
            ...
            ver['django_suit'] = subprocess.Popen(
                'python -c \'import suit; print suit.VERSION\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['django_adminplus'] = subprocess.Popen(
                'python -c \'import adminplus; print adminplus.__version__\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            if DEBUG:
                ...
                open(os.path.join(MEDIA_ROOT, 'data/temp.txt'), 'w').write(
                    subprocess.Popen(
                        'pip show django-filemanager',
                        shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                    ).communicate()[0].strip()
                )
                ver['django_filemanager'] = subprocess.Popen(
                    'head -2 %s | tail -1 | sed \'s/.*: //g\'' % os.path.join(MEDIA_ROOT, 'data/temp.txt'),
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()

            ver_head = open(os.path.join(MEDIA_ROOT, 'media/js/head.load.min.js'), 'r').readline()
            ver['head'] = ver_head[ver_head.find('v')+1: ver_head.rfind('*')].strip()
            ...
            ver['icalendar'] = subprocess.Popen(
                'head -2 %s | tail -1 | sed \'s/.*: //g\'' % os.path.join(MEDIA_ROOT, 'data/temp.txt'),
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['gviz_api'] = '1.8.2'
            ...
            ver['ssh'] = subprocess.Popen(
                'sed \'s/^OpenSSH\_//g\' %s | sed \'s/U.*//\' | sed \'s/,.*//g\' | sed \'s/[a-z]/./g\'' % os.path.join(MEDIA_ROOT, 'data/temp.txt'),
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['git'] = subprocess.Popen(
                'git --version | sed \'s/.*version //g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['nano'] = subprocess.Popen(
                'nano --version | head -1 | sed \'s/.*version //g\' | sed \'s/(.*//g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()

            ver['gdrive'] = subprocess.Popen(
                'drive -v | sed \'s/.*v//g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            if DEBUG:
                ver['pandoc'] = subprocess.Popen(
                    'pandoc --version | head -1 | sed \'s/.*pandoc //g\'',
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()
            else:
                ver['pandoc'] = subprocess.Popen(
                    'dpkg -l pandoc | tail -1 | sed \'s/[a-z ]//g\' | sed \'s/-.*//g\' | sed \'s/~.*//g\'',
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()
            ver['curl'] = subprocess.Popen(
                'curl --version | head -1 | sed \'s/.*curl //g\' | sed \'s/ (.*//g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()

            ver['boto'] = subprocess.Popen(
            ...
            ver['slacker'] = subprocess.Popen(
                'head -2 %s | tail -1 | sed \'s/.*: //g\'' % os.path.join(MEDIA_ROOT, 'data/temp.txt'),
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['dropbox'] = subprocess.Popen(
                'python -c \'import dropbox; print dropbox.__version__\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['requests'] = subprocess.Popen(
                'python -c \'import requests; print requests.__version__\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['simplejson'] = subprocess.Popen(
                'python -c \'import simplejson; print simplejson.__version__\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['virtualenv'] = subprocess.Popen(
                'python -c \'import virtualenv; print virtualenv.__version__\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['pip'] = subprocess.Popen(
                'python -c \'import pip; print pip.__version__\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()

            ver['yuicompressor'] = subprocess.Popen(
                'java -jar %s/../yuicompressor.jar -V' % MEDIA_ROOT,
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()

            disk_sp = subprocess.Popen(
                'df -h | grep \'/dev/\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].split()
            syst['disk'] = [disk_sp[3][:-1] + ' G', disk_sp[2][:-1] + ' G']
            if DEBUG:
                mem_str = subprocess.Popen(
            ...
            syst['drive'] = subprocess.Popen(
                '%s && drive quota | awk \'{ printf $2 " G\t"}\'' % gdrive_dir,
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip().split('\t')
            syst['ssl_cert'] = dash_ssl()

            if not DEBUG:
                ver['ubuntu'] = subprocess.Popen(
                    'lsb_release -a | head -3 | tail -1 | sed \'s/.*Ubuntu //g\'',
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()
                ver['htop'] = subprocess.Popen(
                    'htop --version | head -1 | sed \'s/.*htop //g\' | sed \'s/ \-.*//g\'',
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()
                open(os.path.join(MEDIA_ROOT, 'data/temp.txt'), 'w').write(
                    subprocess.Popen(
                ...
                ver['aws_cli'] = subprocess.Popen(
                    'sed \'s/ Python.*//g\' %s | sed \'s/.*\///g\'' % os.path.join(MEDIA_ROOT, 'data/temp.txt'),
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()

            ver['screen'] = subprocess.Popen(
                'screen --version | sed \'s/.*version//g\' | sed \'s/(.*//g\' | sed \'s/[a-z ]//g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['bash'] = subprocess.Popen(
                'bash --version | head -1 | sed \'s/.*version//g\' | sed \'s/-release.*//g\' | sed \'s/[ ()]//g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['gcc'] = subprocess.Popen(
                'gcc --version | head -1 | sed \'s/.*) //g\' | sed \'s/ .*//g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['make'] = subprocess.Popen(
                'make --version | head -1 | sed \'s/.*Make//g\' | sed \'s/ //g\' | head -1',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip().split('\n')[0]
            ver['cmake'] = subprocess.Popen(
                'cmake --version | head -1 | sed \'s/.*version//g\' | sed \'s/ //g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['ninja'] = subprocess.Popen(
                'ninja --version',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ...
            ver['java'] = subprocess.Popen(
                'sed \'s/.*javac//g\' %s | sed \'s/_/./g\'' % os.path.join(MEDIA_ROOT, 'data/temp.txt'),
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            if DEBUG:
                open(os.path.join(MEDIA_ROOT, 'data/temp.txt'), 'w').write(
                ...
                ver['perl'] = subprocess.Popen(
                    'head -2 %s | tail -1 | sed \'s/).*//g\' | sed \'s/.*(//g\' | sed \'s/[a-z]//g\'' % os.path.join(MEDIA_ROOT, 'data/temp.txt'),
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()
            else:
                ver['perl'] = subprocess.Popen(
                    'dpkg -l perl | tail -1 | sed \'s/[a-z ]//g\' | sed \'s/-.*//g\'',
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                ).communicate()[0].strip()
            ver['ruby'] = subprocess.Popen(
                'ruby --version | sed \'s/.*ruby //g\' | sed \'s/ (.*//g\' | sed \'s/[a-z]/./g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['go'] = subprocess.Popen(
                'go version | sed \'s/.*version go//g\' | sed \'s/ .*//g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()

            ver['coreutils'] = subprocess.Popen(
                'tty --version | head -1 | sed \'s/.*) //g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['wget'] = subprocess.Popen(
                'wget --version | head -1 | sed \'s/.*Wget//g\' | sed \'s/built.*//g\' | sed \'s/ //g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['tar'] = subprocess.Popen(
                'tar --version | head -1 | sed \'s/.*)//g\' | sed \'s/-.*//g\' | sed \'s/ //g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['setuptools'] = subprocess.Popen(
                'python -c \'import setuptools; print setuptools.__version__\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['tkinter'] = subprocess.Popen(
                'python -c \'import Tkinter; print Tkinter.Tcl().eval("info patchlevel")\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['imagemagick'] = subprocess.Popen(
                'mogrify -version | head -1 | sed \'s/\-.*//g\' | sed \'s/.*ImageMagick //g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ver['kerberos'] = subprocess.Popen(
                'klist -V | sed \'s/.*version //g\'',
                shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
            ).communicate()[0].strip()
            ...
            if not DEBUG:
                ...
                subprocess.check_call(
                    'echo "%s" > %s/cache/sys_ver.txt' % (ver_txt, MEDIA_ROOT),
                    shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT
                )
        ...
        if (not DEBUG) and BOT['SLACK']['ADMIN']['MSG_VERSION']:
            send_notify_slack(
                ...
                [{
                    ...
                    'text': '*SUCCESS*: Scheduled weekly *Version* finished @ _%s_\n' % time.ctime(),
                }]
            )
