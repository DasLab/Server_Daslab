    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if IS_SLACK and not DEBUG:
                if (('pickle_aws' in tb or 'cache_aws' in tb) and
                ...
                elif (('pickle_git' in tb or 'cache_git' in tb) and
                ...
                elif (('pickle_slack' in tb or 'cache_slack' in tb) and
                    (('500' in tb and 'Internal Server Error' in tb) or
                        ('503' in tb and 'Service' in tb and 'Unavailable' in tb) or
                        ('504' in tb and 'gateway' in tb.lower()) or ('HTTPSConnectionPool' in tb) or
                        ('solr_failed' in tb))):
                ...
                elif (('pickle_dropbox' in tb or 'cache_dropbox' in tb) and
                    (('500' in tb and 'server' in tb) or
                        ('502' in tb and 'Bad Gateway' in tb) or
