...
os.popen('mysqldump --quick daslab -u root -pbeckman | gzip > %s/../backup_mysql.gz' % MEDIA_ROOT)
print "    \033[92mSUCCESS\033[0m: \033[94mMySQL\033[0m database dumped."

print "#2: Backing up static files..."
os.popen('cd %s && tar zcf ../backup_static.tgz data/' % MEDIA_ROOT)
...
os.popen('cd %s && tar zcf ../backup_apache.tgz apache2/' % MEDIA_ROOT)
